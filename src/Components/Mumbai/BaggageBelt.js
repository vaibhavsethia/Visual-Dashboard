...
export class BaggageBelt extends Component {
    ...
    render() {
        const {Total,Belt1,Belt2,Belt3,Belt4,Belt5,Belt6,Belt7,Belt8,Belt9,UtilBelt1,UtilBelt2,UtilBelt3,UtilBelt4,UtilBelt5,UtilBelt6,UtilBelt7,UtilBelt8,UtilBelt9}=this.state;
        const data1 = [
        ...
        return (
            <div>
                ...
                <p className="f3 pa2 tc mb1">
                    Comparison among the Baggage Belts used at CSMI Airport is as follows: 
                </p>
                <div className="fl w-60 pa3 f4">
                    <VictoryPie 
                        ...
                        colorScale={["#adb9db","#93a6db","#6e87cc","#5471bf","#3a5dba","#2048b3","#0531a6","#062475","#061745"]}
                ...
                <div className="fl w-30 pa3 Home-key shadow-2">
                    ...
                    <p className="f3 pa2 tc mb1">
                    Percentage Utilization of each Baggage belt at CSMI Airport is as follows: 
                    </p>
