...
export class BoardingGate extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <p className="f2 tc mb1">Netaji Subhash Chandra Bose International Airport</p>
                <p className="f4 tc mt1">Kolkata</p>
                <p className="f3 pa2 tc mb1">
                    Comparison among the entry gates used at NSBI Airport is as follows: 
                </p>
