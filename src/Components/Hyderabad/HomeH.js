...
export class HomeH extends Component {
    constructor(props) {
        super(props)
                                                        ...
                                                        <Washroom></Washroom>
                                                            ...
                                                            <Lounges></Lounges>
                                                                ...
                                                                <Vending></Vending>
                                                                    :
                                                                    <div>
                                                                        <p className="f3 tc mb1">Rajiv Gandhi International Airport</p>
                                                                        <p className="f4 tc mt1">New Delhi</p>
                                                                        <p className="pl3 pr3 f4 fw3">
                                                                            <strong>Rajiv Gandhi International Airport</strong> is an international airport that serves Hyderabad, 
                                                                            the capital of the Indian state of Telangana. It is located in Shamshabad, about 24 kilometres 
                                                                            south of Hyderabad. It was opened on 23 March 2008 to replace Begumpet Airport. It 
                                                                            is named after Rajiv Gandhi, former Prime Minister of India. It is the only airport in India 
                                                                            ranking in AirHelp's list of top 10 airports in the world.
                                                                        </p>
                                                                        <p className="pl3 pr3 f4 fw3">
                                                                            The airport has one passenger terminal, a cargo terminal and two runways. 
                                                                            There are also aviation training facilities, a fuel farm, a solar power plant and 
                                                                            two MRO facilities. As of 2019 March, RGIA is the sixth busiest airport 
                                                                            by passenger traffic in India.[5] The airport served about 21.4 million passengers 
                                                                            in fiscal year 2018–19. The airport serves as a hub for Alliance Air (India), 
                                                                            Blue Dart Aviation, SpiceJet, Lufthansa Cargo, Quikjet Cargo, and TruJet, 
                                                                            IndiGo and focus city for Air India.
                                                                        </p>
                                                                        {/*---------------------Chart---------------------*/}
