...
export class BoardingGate extends Component {
    ...
    render() {
        const {Total,Gate1,Gate2,Gate3,Gate4,Gate5,Gate6,Gate7}=this.state;
        const data = [
            ...
            {x: parseFloat(Gate7*100/Total).toFixed(2) , y: parseInt(Gate7)},
          ];
        return (
            <div>
                <p className="f2 tc mb1">Kempigowda International Airport</p>
                <p className="f4 tc mt1">Bangalore</p>
                <p className="f3 pa2 tc mb1">
                    Comparison among the entry gates used at KI Airport is as follows: 
                </p>
                <div className="fl w-60 pa3 f4">
                    <VictoryPie 
                        ...
                        colorScale={["#4f72db","#2a56db","#063ad6","#0731ad","#04278f","#031b61","#031340"]}
                ...
                <div className="fl w-30 pa3 Home-key shadow-2">
                    <p className="f3 b tc">Key</p>
                        <div className="flex flex-column">
                            ...
                            <div className="w-100 pa3 mr2 Key-hover">
                                <div className="link black f4 " href="#" title="IGI Airport" >
                                    <span className="Home-key-box Home-key-box-seven"></span>: Gate7
                                </div>
                            </div>
                        </div>
                    </div>
